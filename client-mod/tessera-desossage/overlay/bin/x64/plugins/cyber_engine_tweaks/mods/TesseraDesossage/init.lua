...
TesseraDesossage.levers = {
  ...
  { key = "radios", label = "Radios ambiantes", note = "Nouveau (2026-07-19, PIN IN-GAME) — pose le fact save radio_on=0 (SetFact). Hypothèse à confirmer en jeu ; fallback device Radio.TurnOffDevice documenté si sans effet" },
  ...
  { key = "phoneCalls", label = "Appels téléphoniques", note = "Réel (ex-questTriggers) — décoché = tous les appels entrants bloqués (ApplyPhoneCallRestriction), confirmé 2026-07-03 (icône radio déverrouillée). Donneurs de quête par proximité désormais couverts par le blocage natif des spawn nodes (tessera-client phase 2)" },
